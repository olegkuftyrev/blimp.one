export const plquestions = [
  {
    id: "1",
    label: "If the net sales were $100,000 this year and the SSS was -5.5%, what were the net sales last year?",
    explanation: "Last year net sales = This year net sales ÷ (1 + SSS). Since SSS = -5.5% (–0.055), calculate 100,000 ÷ 0.945 ≈ 105,820.",
    a1: "$94,500",
    a2: "$100,000",
    a3: "$105,820",
    a4: "$112,000",
  ...
  },
  {
    ...
    explanation: "Check average = Net Sales ÷ Number of transactions. Calculate 110,000 ÷ 10,500 ≈ 10.48.",
    a1: "$10.00",
    a2: "$10.48",
    a3: "$10.58",
    a4: "$11.00",
  ...
  },
  {
    ...
    explanation: "Net Sales = Number of transactions × Check average. Calculate 11,000 × 10.58 = 116,380.",
    a1: "$116,380",
    a2: "$115,800",
    a3: "$107,150",
    a4: "$120,000",
  ...
  },
  {
    ...
    explanation: "First calculate COGS: Beginning Inventory + Purchases = 5,000 + 9,400 = 14,400; subtract Transfer Out: 14,400 – 250 = 14,150; subtract Ending Inventory: 14,150 – 4,750 = 9,400. Then COGS% = 9,400 ÷ 25,500 ≈ 0.3686, or 36.9%.",
    a1: "36.9%",
    a2: "38.9%",
    a3: "33.9%",
    a4: "34.6%",
  ...
  },
  {
    ...
    explanation: "Net Sales = COGS$ ÷ COGS%. Calculate 9,850 ÷ 0.315 ≈ 31,269.84 (rounded to $31,270).",
    a1: "$31,270",
    a2: "$33,500",
    a3: "$29,000",
    a4: "$35,000",
  ...
  },
  {
    ...
    explanation: "Total Labor Cost = Direct Labor + GM Salary + AM & Chef Salary + Tax & Benefits. Calculate 16,000 + 4,600 + 3,000 + 6,800 = 30,400.",
    a1: "$27,400",
    a2: "$30,400",
    a3: "$20,900",
    a4: "$27,410",
  ...
  },
  {
    ...
    explanation: "Net Sales = Total Labor Cost ÷ Total Labor %. Calculate 29,500 ÷ 0.26 ≈ 113,461.54 (rounded to $113,462).",
    a1: "$113,462",
    a2: "$110,000",
    a3: "$115,000",
    a4: "$120,000",
  ...
  },
  {
    ...
    explanation: "First sum the cost percentages: 33.6% + 25.5% + 7.8% + 0.3% + 5% = 72.2%. Controllable Profit% = 100% – 72.2% = 27.8%. Net Sales = Controllable Profit ÷ Controllable Profit% = 42,000 ÷ 0.278 ≈ 151,079.",
    a1: "$150,000",
    a2: "$151,079",
    a3: "$155,000",
    a4: "$145,000",
    ...
    explanation: "Сначала вычислите контрольную прибыль: 110 000 – (36 250 + 27 000 + 8 750 + 750) = 37 250. Процент = 37 250 ÷ 110 000 ≈ 0.3386, или 33.9 %.",
    a1: "30.5%",
    a2: "32.7%",
    a3: "31.1%",
    a4: "33.9%",
  ...
  },
  {
    ...
    explanation: "Last year net sales = This year net sales ÷ (1 + SSS). Since SSS = 7.5% (0.075), calculate 100,000 ÷ 1.075 ≈ 93,023.",
    a1: "$93,023",
    a2: "$100,000",
    a3: "$107,500",
    a4: "$92,500",
  ...
  },
  {
    ...
    explanation: "Net Sales = Number of transactions × Check average. Calculate 12,500 × 10.88 = 136,000.",
    a1: "$136,000",
    a2: "$135,000",
    a3: "$140,000",
    a4: "$130,000",
  ...
  },
  {
    ...
    explanation: "Calculate COGS: 5,000 + 9,600 + 150 – 4,750 = 10,000. Then COGS% = 10,000 ÷ 29,500 ≈ 0.33898, or 33.9%.",
    a1: "36.8%",
    a2: "33.9%",
    a3: "31.8%",
    ...
    },
  {
    ...
    explanation: "SSS = (This Year – Last Year) ÷ Last Year = (99,500 – 110,000) ÷ 110,000 = –10,500 ÷ 110,000 ≈ –0.0955, or –9.55%, rounded to –9.5%.",
    a1: "-9.5%",
    a2: "-10.0%",
    a3: "-9.0%",
    a4: "-8.5%",
  ...
  },
  {
    ...
    explanation: "Net Sales = COGS$ ÷ COGS%. Calculate 9,250 ÷ 0.328 ≈ 28,231.71 (rounded to $28,232).",
    a1: "$28,232",
    a2: "$30,000",
    a3: "$26,500",
    a4: "$29,000",
    ...
    explanation: "Direct Labor Cost = Total Labor Cost – Management Labor – Tax & Benefits = 27,750 – 4,575 – 8,150 = 15,025. Direct Labor Hours = Direct Labor Cost ÷ Average Wage = 15,025 ÷ 10.25 ≈ 1,465.85, rounded to 1,466.",
    a1: "1,466",
    a2: "1,685",
    a3: "1,568",
    a4: "1,644",
